    ...
    <div>
      <>
        <main className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-gray-900 p-6 md:p-12 rounded-3xl shadow-2xl shadow-black/70 borde border-gray-800">
        ...
        <div className="mt-14 pt-8 border-t border-gray-800">
          <h2 className="text-3xl font-bold text-gray-100 mb-8 flex items-center">
            <BookOpen className="w-7 mr-3 text-blue-500" /> Detailed Preparation
            Step
          </h2>
          ...
          <ol className="space-y-6 list-none text-gray-300">
            {instructions.map((step, index) => (
              <li
                key={index}
                className="text-lg leading-relaxed bg-gray-800 p-2 rounded-xl border-1-6 border-blue-500 shadow-black-30 transition duration-300 hover:gray-700/50"
              >
